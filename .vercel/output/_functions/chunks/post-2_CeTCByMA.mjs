const id = "fr/post-2.md";
						...
						new Proxy({"src":"/_astro/brad.DxbZHamT.avif","width":320,"height":320,"format":"avif","fsPath":"/Users/nrojasma/Documents/lsvr/src/images/blog/brad.avif"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/nrojasma/Documents/lsvr/src/images/blog/brad.avif";
							}
					...
					,authorImageAlt:"Avatar Description",pubDate:new Date(1707523200000),cardImage:
						new Proxy({"src":"/_astro/post-2.D_u0v5R3.avif","width":1500,"height":1000,"format":"avif","fsPath":"/Users/nrojasma/Documents/lsvr/src/images/blog/post-2.avif"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/nrojasma/Documents/lsvr/src/images/blog/post-2.avif";
							}
					...
					,cardImageAlt:"Man in black sweatpants using DEWALT circular saw and cutting a wood plank",readTime:5,tags:["sécurité","artisanat","gestion"]};
						const _internal = {
							type: 'content',
							filePath: "/Users/nrojasma/Documents/lsvr/src/content/blog/fr/post-2.md",
							rawData: undefined,
						};
