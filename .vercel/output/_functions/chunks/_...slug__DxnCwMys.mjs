/* empty css                         */
import { m as createAstro, n as createComponent, o as renderTemplate, s as renderComponent, t as renderScript, p as maybeRenderHead } from './astro/server_CAp2qBl3.mjs';
import 'kleur/colors';
...
Tabla de contenido:
</p> <div id="toc" class=""> <ul class="space-y-2 text-pretty text-base text-neutral-700 transition duration-300 dark:text-neutral-400"></ul> </div> </div> </div> <div class="md:pt-8"> <h1 class="mb-4 text-balance text-center text-2xl font-bold text-neutral-800 dark:text-neutral-200 sm:text-3xl md:mb-6 md:text-left"> ${post.data.title} </h1> <article class="text-pretty text-lg text-neutral-700 dark:text-neutral-300"> ${renderComponent($$result2, "Content", Content, {})} </article> </div> </div> </div> </section> ` })}  ${renderScript($$result, "/Users/nrojasma/Documents/lsvr/src/pages/insights/[...slug].astro?astro&type=script&index=0&lang.ts")} ${renderScript($$result, "/Users/nrojasma/Documents/lsvr/src/pages/insights/[...slug].astro?astro&type=script&index=1&lang.ts")}`;
}, "/Users/nrojasma/Documents/lsvr/src/pages/insights/[...slug].astro", void 0);

const $$file = "/Users/nrojasma/Documents/lsvr/src/pages/insights/[...slug].astro";
